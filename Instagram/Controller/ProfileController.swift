...
class ProfileController: UICollectionViewController {
    ...
    // Initialize this controller with a user object
    init(user: User) {
        self.user = user
...
extension ProfileController {
    // Push the FeedController which only shows one post when we click on a picture
...
extension ProfileController: ProfileHeaderDelegate {
    func header(_ profileHeader: ProfileHeader, didTapActionButtonFor user: User) {
        ...
        if user.isCurrentUser {
            ...
            // Handle unfollow user here
            UserService.unfollow(uid: user.uid) { error in
                // Update UI after unfollowing the user
            ...
            // Handle follow user here
            UserService.follow(uid: user.uid) { error in
                // Update UI after following the user
